...
import read.ui.dialog.ReadSettingDialog;
import read.utils.BookManager;
import read.utils.StringUtils;
import read.widget.page.BasePageLoader;
import read.widget.page.PageView;
...
public class ReadActivity extends AppCompatActivity {
    ...
    /*    =findViewById(R.id.read_tv_download)
...
//        super.setUpToolbar(toolbar);
    ...
    private void initTopMenu() {
        if (Build.VERSION.SDK_INT >= 19) {
            mAblTopMenu.setPadding(0, ScreenUtils.getStatusBarHeight(this), 0, 0);
        }
    }
...
//        mLvCategory.setFastScrollEnabled(true);
    ...
    protected void initClick() {
        mPageLoader.setOnPageChangeListener(
                new BasePageLoader.OnPageChangeListener() {
...
//                        finishChapter();
                    ...
                    @Override
                    public void onCategoryFinish(List<TxtChapterBean> chapters) {
                        for (TxtChapterBean chapter : chapters) {
                            chapter.setTitle(StringUtils.convertCC(chapter.getTitle()));
                        }
//                        mCategoryAdapter.refreshItems(chapters);
                    ...
                    public void onPageCountChange(int count) {
                        ...
                        if (mPageLoader.getPageStatus() == BasePageLoader.STATUS_LOADING
                                || mPageLoader.getPageStatus() == BasePageLoader.STATUS_ERROR) {
...
//        showCategory();
    ...
    public void saveChapterInfo(String folderName, String fileName, String content) {
        File file = BookManager.getInstance().getBookFile(folderName, fileName);
        //获取流并存储
        Writer writer = null;
        try {
