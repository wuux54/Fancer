...
public class Constant {
    ...
    public static String BOOK_CACHE_PATH = BookFileUtils.getCachePath()+ File.separator
            + "book_cache"+ File.separator ;
    //文件阅读记录保存的路径
    public static String BOOK_RECORD_PATH = BookFileUtils.getCachePath() + File.separator
