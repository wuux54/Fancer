...
import static com.read.local.ReadSettingManager.SHARED_READ_CONVERT_TYPE;
...
public class StringUtils {
    ...
    public static void setApp(Application app1){
        app=app1;
    }
    ...
    public static String convertCC(String input)
    {
        ...
        return (convertType != 0)?
                ChineseConverter.convert(input, currentConversionType, app):input;
    }
}
