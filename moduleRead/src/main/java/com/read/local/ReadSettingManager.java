package com.read.local;


import android.content.Context;

import com.read.utils.SharedPreUtils;
import com.read.widget.page.PageMode;
import com.read.widget.page.PageStyle;
...
public class ReadSettingManager {
    ...
    public int getTextSize(Context mContext) {
        return sharedPreUtils.getInt(SHARED_READ_TEXT_SIZE, DensityUtils.sp2px(mContext,28));
    }
